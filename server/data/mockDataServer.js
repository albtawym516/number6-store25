const { OrderStatus } = require('../typesServer.js');
...
const sampleCartItems = [
    { id: 'ci1', product: mockProducts[1], quantity: 1, size: 'M', color: 'وردي' },
    { id: 'ci2', product: mockProducts[0], quantity: 1, size: 'L', color: 'أسود' },
];

const sampleCartItems2 = [
    { id: 'ci3', product: mockProducts[2], quantity: 1, size: '6 سنوات', color: 'أحمر' },
];
